                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <div class="blog-date">
                                    <h6 class="font-weight-bold mb-n1"><?php echo $row['date'] ?></h6>
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            ...
                            <h2 class="mb-3"><?php echo $row['caption'] ?></h2>
                            ...
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="img/<?php echo $row['postimage'] ?>">
