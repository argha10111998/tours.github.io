      ...
      ?>
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="package-item bg-white mb-2">
                        ...
                        <img class="img-fluid" src="img/<?php echo $row['image']; ?>" alt="" width="500px">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i>><?php echo $row['persons'];?></small>
                            </div>
                            <a class="h5 text-decoration-none" href="">><?php echo $row['caption'];?></a>
                        ...
                        <div class="card-body rounded-bottom bg-white p-5">
                            <form action="storeuser.php" method="POST">
                                <div class="form-group">
                                    <input type="text" class="form-control p-4" name="fullname" placeholder="Your FullName"/>
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control p-4" name="email" placeholder="Your email"/>
                                </div>
                                <div class="form-group">
                                <input type="text" class="form-control p-4" name="address" placeholder="Your Adress"/>
                                </div>
                                <div>
